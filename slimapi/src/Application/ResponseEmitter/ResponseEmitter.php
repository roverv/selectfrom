...
class ResponseEmitter extends SlimResponseEmitter
{
    ...
    public function emit(ResponseInterface $response): void
    {
        ...
        // in some cases the headers are already set, eg when using outputbuffering on importdatabaseaction
        if($response->hasHeader('Access-Control-Allow-Credentials') === false) {
